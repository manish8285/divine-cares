    ...
    <div className="container py-5">
      <div className="row justify-content-start">
        <div className="col-lg-8 text-center text-lg-start">
          <h5 className="d-inline-block text-black text-uppercase border-bottom border-5 bg-white" style={{borderColor: 'rgba(256, 256, 256, .3) !important'}}>Doctor Consultation @100/-</h5>
