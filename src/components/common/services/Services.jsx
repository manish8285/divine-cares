      ...
      <div className="row g-5">
        ...
        <div className="col-lg-4 col-md-6">
          <div className="service-item bg-light rounded d-flex flex-column align-items-center justify-content-center text-center">
            ...
            <h4 className="mb-3">Diagnostic Tests</h4>
            <p className="m-0">Comprehensive diagnostic facilities available, including X-Rays, Ultrasound, ECG, Blood Tests and more.</p>
            <a className="btn btn-lg btn-primary rounded-pill" href>
              <i className="bi bi-arrow-right" />
            </a>
          </div>
        ...
        <div className="col-lg-4 col-md-6">
          <div className="service-item bg-light rounded d-flex flex-column align-items-center justify-content-center text-center">
            ...
            <p className="m-0">24/7 Call Support for medical queries and treatment guidance.</p>
            <a className="btn btn-lg btn-primary rounded-pill" href>
              <i className="bi bi-arrow-right" />
            </a>
          </div>
        ...
        <div className="col-lg-4 col-md-6">
          <div className="service-item bg-light rounded d-flex flex-column align-items-center justify-content-center text-center">
            ...
            <p className="m-0">Convenient pickup and drop services available for diagnostic tests and medical emergencies.</p>
            <a className="btn btn-lg btn-primary rounded-pill" href>
              <i className="bi bi-arrow-right" />
            </a>
          </div>
        ...
        <div className="col-lg-4 col-md-6">
          <div className="service-item bg-light rounded d-flex flex-column align-items-center justify-content-center text-center">
            ...
            <p className="m-0">Wide range of authentic homoeopathic medicines available under one roof.</p>
            <a className="btn btn-lg btn-primary rounded-pill" href>
              <i className="bi bi-arrow-right" />
            </a>
          </div>
        ...
        <div className="col-lg-4 col-md-6">
          <div className="service-item bg-light rounded d-flex flex-column align-items-center justify-content-center text-center">
            ...
            <p className="m-0">Comprehensive blood testing facilities available, including Thyroid, Fasting Profile, Complete Blood Count, and more.</p>
            <a className="btn btn-lg btn-primary rounded-pill" href>
              <i className="bi bi-arrow-right" />
            </a>
          </div>
